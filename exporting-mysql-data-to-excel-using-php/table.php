		...
		<section class="container">
			<div class="form-group custom-input-space has-feedback">
				<div class="page-heading">
					<h3 class="post-title">Exporting MySQL Data to Excel using PHP - Learn infinity</h3>
				</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<table width="100%" border="1">
										...
										//get rows query
										$query = mysqli_query($con, "SELECT * FROM li_ajax_post_load ORDER BY post_id DESC");
										...
										<tr>
											...
											<td><?php echo ucfirst($row["post_desc"]); ?></td>
										</tr>
										<?php $sno++;
											}
										} ?>
